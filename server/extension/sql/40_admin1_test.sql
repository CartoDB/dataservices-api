...
SELECT cdb_geocoder_server.cdb_geocode_admin1_polygon('test_user', 'California');
SELECT cdb_geocoder_server.cdb_geocode_admin1_polygon('test_user', 'California', 'United States');
